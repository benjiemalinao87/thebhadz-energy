...
- Command Center create/edit flows (Finance ledger, Install Ops costing/crew, similar ops tools): prefer a primary button that opens a modal (`<dialog>`), not an always-open form that pushes the list below the fold.
