...
(function () {
  ...
  // Run immediately (not on DOMContentLoaded): under the SPA router this script is
  // injected long after that event already fired once for the shell's initial load.
  (function () {
